...
<header class="py-4 shadow-sm bg-white">
    <div class="container flex items-center justify-between">
        <!-- logo -->
        <a href="<?= url("index") ?>">
            <img src="<?= asset("images/logo.svg") ?>" class="w-32" alt="">
        </a>
        <!-- searchbar -->
        <form action="<?= url('search') ?>" method="get" class="w-full max-w-xl relative flex">
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="account.html" class="text-center text-gray-600 hover:text-primary transition relative">
                <div class="text-2xl">
