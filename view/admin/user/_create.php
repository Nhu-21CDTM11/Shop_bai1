    ...
    <form action="<?= url('admin.user.create') ?>" method="post" >
        ...
        <div class="mx-auto w-1/2">
            <div class="mb-6">
                ...
                <input type="email" id="" value="<?= old('email', "") ?>" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-blue-100 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <?= error('email')?>
            </div>
